...
class _ApiManager implements ApiManager {
  ...
  @override
  Future<GetBooksResponseDto> getBooks() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBooksResponseDto>(
    ...
    late GetBooksResponseDto _value;
    try {
      _value = GetBooksResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
